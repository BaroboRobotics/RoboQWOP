...
<div id="page-sidebar">
	...
	<!-- load the hover images so they are ready to be shown when user hovers --><div class="hidden">
	    ...
	    <div id="promo" class="rounded_corners">
			...
			<a href="http://store.barobo.com/mobot/gorilla-bundle.html" style="margin-top:-5px;" id="bottompromo" class="promolink rounder_corners_bottom"><span>Buy three Mobots with connectors $827.75</span></a>
