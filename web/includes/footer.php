<footer id="page-footer" class="clearfix">
	<div class="social-widget" style="margin-top: 50px;">
        ...
        <a target="_blank" href="http://store.barobo.com/mobot/mobot.html">Buy a Mobot</a> | <a target="_blank" href="https://github.com/Barobo/RoboQWOP">Help develop RoboQWOP</a> 
	</div>
</footer>