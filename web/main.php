	                    ...
	                    <div class="clearfix">
	                        ...
	                        <div class="box arrow-controls">
	                            <div id="mancer-btngrp-1">
	                                <button id="mancer-up" class="arrow-button" onmousedown="handleKeyEvent(38, true);"><img src="img/icons/arrow-up.png" alt="Up" title="Up" width="48" height="48" /></button>
	                            </div>
	                            <div id="mancer-btngrp-2">
	                                <button id="mancer-left" class="arrow-button" onmousedown="handleKeyEvent(37, true);"><img src="img/icons/arrow-left.png" alt="Left" title="Left" width="48" height="48" /></button><button id="mancer-down" class="arrow-button" onmousedown="handleKeyEvent(40, true);"><img src="img/icons/arrow-down.png" alt="Down" title="Down" width="48" height="48" /></button><button id="mancer-right" class="arrow-button" onmousedown="handleKeyEvent(39, true);"><img src="img/icons/arrow-right.png" alt="Right" title="Right" width="48" height="48" /></button>
	                            </div>
